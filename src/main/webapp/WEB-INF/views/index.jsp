  ...
  <div class="navout">
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-indicators">
        <button type="button" data-bs-target="#hero-carousel" data-bs-slide-to="0" aria-label="Slide 1" class="active" aria-current="true"></button>
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item c-item">
          <img src="<c:url value='/WEB-INF/views/image/Cafe2.jpg'/>" class="d-block w-100 c-img" alt="Slide 2">
          <div class="carousel-caption top-0 mt-4">
        ...
        <div class="carousel-item c-item">
          <img src="<c:url value='/WEB-INF/views/image/Cafe3.jpg'/>" class="d-block w-100 c-img" alt="Slide 3">
          <div class="carousel-caption top-0 mt-4">
            <p class="text-uppercase fs-3 mt-5">이번주의 추천 Pick Up</p>
        ...
        <div class="carousel-item c-item">
          <img src="<c:url value='/WEB-INF/views/image/Cafe4.jpg'/>" class="d-block w-100 c-img" alt="Slide 4">
          <div class="carousel-caption top-0 mt-4">
            <p class="text-uppercase fs-3 mt-5">이번주의 추천 Pick Up</p>
        ...
        <div class="carousel-item c-item">
          <img src="<c:url value='/WEB-INF/views/image/Cafe5.jpg'/>" class="d-block w-100 c-img" alt="Slide 5">
          <div class="carousel-caption top-0 mt-4">
            <p class="text-uppercase fs-3 mt-5">이번주의 추천 Pick Up</p>

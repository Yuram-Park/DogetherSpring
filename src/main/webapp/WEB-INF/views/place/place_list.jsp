...
<link rel="stylesheet" href="<c:url value='/resources/css/place_list.css'/>">
</head>
<body>
  ...
  <!-- Side Bar -->
  <jsp:include page="/WEB-INF/views/place/placeSideBar.jsp">
  ...
  <div class="checkresult">
    ...
    <div class="results">
      <c:forEach var="place" items="${places}" begin="1" end="6" step="1" varStatus="status">
      <div class="cards">
        <a href="place_detail.jsp?place_id=${place.place_id}" class="card mb-3" style="max-width: 600px; margin-top: 40px;">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="./image/Cafe${status.index}.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title">${place.place_name}<div class="score">${place.place_score}</div>
                </h4>
                <p class="card-text">현재 위치에서 1.2km 거리</p>
                <p class="card-text">
                  <small class="text-body-secondary">${place.place_category} | ${place.place_address} <br> #주차장 #실내 #토요일 영업 #일요일 영업 #소형견 #중형견 <br> ${place.place_call}</small>
                </p>
              </div>
            </div>
          </div>
